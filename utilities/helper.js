let response = require('./responesManager');
let CryptoJS = require("crypto-js");
exports.passwordDecryptor = async (passwordDecrypt) => {
    try {
        var decLayer1 = CryptoJS.TripleDES.decrypt(passwordDecrypt, process.env.PASSWORD_ENCRYPTION_SECRET);
